function main() {
    ...
    function update_input_output() {
        ...
        var w2 = Math.floor(((v.w1.value - (v.d.value * (v.f.value-1)) + 2 * v.p.value) -1) / v.s.value + 1);
        var h2 = Math.floor(((v.h1.value - (v.d.value * (v.f.value-1)) + 2 * v.p.value) -1)/ v.s.value + 1);
